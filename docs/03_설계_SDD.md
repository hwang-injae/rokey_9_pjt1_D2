...
stateDiagram-v2
  ...
  PAUSED --> PICK: ROBOT_ERROR 2단 (E52 · 신호 1 → 그리퍼만 열기 → 사람 수거 → 신호 2 → 위로 → HOME → ERROR 기록 → 다음 용기)
