...
'V-10':'컵 안에 솔을 넣을 때 깊이와 부딪힘을 확인한다','V-18':'닦는 동안(고정 높이로 누른 채) 수세미 툴·솔이 그리퍼 안에서 밀리거나 돌지 않는지 확인한다','V-13':'브라우저에서 시작 버튼을 누르면 가짜 flow가 반응하는지 확인한다','V-14':'그릇 2개를 겹치거나 어긋나게 놓고 "찾아서 집기"를 10번 해 성공률을 잰다',
