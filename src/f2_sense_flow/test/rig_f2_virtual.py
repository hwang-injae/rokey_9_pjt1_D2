...
_WEIGH_Z, _WASTE_Z = 425.0, 300.0        # config_virtual/cell.yaml 의 티칭 자세 z
...
def main() -> int:
    ...
    try:
        ...
        log.info(f'설정 — 후퇴 높이 {safe_z} mm(E7 이후 safe_z 의 뜻) · shake.WASTE {conf["shake"]["WASTE"]} · dip {conf["dip"]}')
