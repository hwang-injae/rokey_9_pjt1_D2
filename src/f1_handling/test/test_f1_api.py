...
from cobot_api import F1Api, PickResult, Result, check_api
...
def test_return_types_of_skeleton_functions():
    """아직 골격인 함수(🚧 pick · rack_place)는 약속된 타입만 돌려준다. move_to · place · tool 은 test_f1_handling.py."""
...
def test_skeleton_returns_ok():
    ...
    results = [handling.pick('RET_C', 'CUP'), handling.rack_place('RACK_C2', 'CUP')]
